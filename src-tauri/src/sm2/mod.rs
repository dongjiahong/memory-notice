...
impl Item {
    ...
    /// - 0 - complete blackout. 完全不会
    /// - 1 - incorrect response; the correct one remembered. 答错，正确的那个记得
    /// - 2 - incorrect response; where the correct one seemed easy to recall. 答错，正确的很容易记起来
    /// - 3 - correct response recalled with serious difficulty. 正确，但是艰难的回忆起来
    /// - 4 - correct response after a hesitation. 犹豫后选择正确
    /// - 5 - perfect response. 完美答案
